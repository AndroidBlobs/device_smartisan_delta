...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/afe_proxy_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/afe_proxy_audio_policy_configuration.xml \
...
PRODUCT_PACKAGES += \
    ...
    qca6234-service.sh \
    write-agingtest-flag-to-f.sh \
    write-agingtest-flag-to-p.sh \
...
# Inherit vendor
$(call inherit-product, vendor/smartisan/delta/delta-vendor.mk)